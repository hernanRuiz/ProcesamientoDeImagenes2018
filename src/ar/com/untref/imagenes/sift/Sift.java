package ar.com.untref.imagenes.sift;
...
public class Sift {
	...
	public static void aplicarMetodoSift(URL urlImagen1, URL urlImagen2)
			throws Exception {

		File f1 = new File(Sift.class.getResource("/resources/pensador.gif").getPath());
		
		MBFImage query = ImageUtilities.readMBF(f1);
		MBFImage target = ImageUtilities.readMBF(f1);
